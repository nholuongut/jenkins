...
def call (Map args = [:]) {
  ...
  //
  // git@github.com:nholuongut/Kubernetes -> nholuongut/Kubernetes
  String ownerRepo = args.repo.split(':')[-1]
  //
  // https://github.com/nholuongut/Kubernetes -> nholuongut/Kubernetes
  ownerRepo = ownerRepo.split('/')[-2, -1].join('/')
  //
  // nholuongut/Kubernetes.git -> nholuongut/Kubernetes
